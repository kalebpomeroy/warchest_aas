...
export default class Board extends Component {
    ...
    render() {
        ...
        return (
            <div className='img-fill col-8 p-5 border position-relative '>
                ...
                {_.map(this.props.board.coins_on, (c, u) => this.add_coin(u, c.space))}
    ...
    add_coin(type, coordinates, z, highlighted) {
        z = z || 2;
        var scale = 8;
        ...
        return <div key={coordinates} style={pos} className={'position-absolute'}>
            <Coin name={type} selected={(!highlighted && this.props.coin === type)}/>
        </div>
    }
}
